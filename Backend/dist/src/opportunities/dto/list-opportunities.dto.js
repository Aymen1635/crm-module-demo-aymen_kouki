...
exports.ListOpportunitiesDto = void 0;
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
const client_1 = require("@prisma/client");
class ListOpportunitiesDto {
    constructor() {
...
], ListOpportunitiesDto.prototype, "stage", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
...
], ListOpportunitiesDto.prototype, "page", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
    ...
    (0, class_transformer_1.Transform)(({ value }) => parseInt(String(value), 10)),
    __metadata("design:type", Number)
], ListOpportunitiesDto.prototype, "limit", void 0);
